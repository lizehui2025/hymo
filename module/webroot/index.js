...
function getPersistedConfig(config) {
  return {
    ...
    trace_steps: Boolean(config.trace_steps),
    trace_params: Boolean(config.trace_params),
    log_force_fsync: Boolean(config.log_force_fsync),
    log_rotate_mb: Number(config.log_rotate_mb || 16),
    log_rotate_keep: Number(config.log_rotate_keep || 8),
